    ...
    return Scaffold(
      ...
      body: Column(
        mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Text("Empieza por darle un nombre",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
            Padding(
            ...
            RaisedButton(
              onPressed: (){
                if (_formKey.currentState.validate()) {
                  ...
                  db.addTooBook(widget.uid, texto)
                  .then((documentId) => {
                    Navigator.push(context,new MaterialPageRoute(builder: (context) => WriteChatsTB(nombreTB: texto,tooBookId: documentId,)))
                  });
                }
              },
