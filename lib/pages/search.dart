        ...
        body:
          ...
          Column(
            ...
            children: <Widget>[
              ...
              index: _selectedPage,
              children: <Widget>[
                TabSearch(titulo: "Recientes",busqueda: "recientes",uid: widget.uid,),
                TabSearch(titulo: "Top Semanal",busqueda: "semanal",uid:widget.uid),
                TabSearch(titulo: "Humor",busqueda: "semanal",uid:widget.uid),
                TabSearch(titulo: "Terror",busqueda: "recientes",uid: widget.uid,),
                TabSearch(titulo: "MicroRelatos",busqueda: "recientes",uid: widget.uid,),
              ],
        ),
            ],
          )
              ...
              default:
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext ctx, int index) {
                    return Column(
                      children: <Widget>[
                        WidgetTB(toobook: TooBook.fromSnapshot(snapshot.data.documents[index]),uid: widget.uid,),
                        Divider()
                      ],
                    );
                  },
